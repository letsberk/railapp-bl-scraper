...
BL_BASE      = "https://betrieblive.noncd.db.de"
...
async def login(client: httpx.AsyncClient) -> str:
    ...
    # Basis-URL: https://betrieblive.noncd.db.de
    bodies = [
...
async def fetch(client: httpx.AsyncClient, token: str) -> list:
    ...
    ep = "/api/v1/incidents?limit=50&withPins=true&status=open,closed_recently"
    try:
...
async def fetch_chat(client: httpx.AsyncClient, token: str, incident_id: str) -> list:
    ...
    ep = f"/api/v1/incidents/{incident_id}/messages/"
    try:
