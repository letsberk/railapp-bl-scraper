...
BL_BASE      = "https://betrieblive.reisenden.info"   # Login
BL_API_BASE  = "https://betrieblive.noncd.db.de"       # API Daten
...
async def fetch(client: httpx.AsyncClient, token: str) -> list:
    hdrs = {
        ...
        "Authorization": f"Bearer {token}" if token and token != "cookie" else "",
    }
